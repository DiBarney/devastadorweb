...
<body class="text-museo">
    ...
    <main class="w-full">
        <!-- Call to action -->
        <section class="w-full max-w-screen-xl m-auto callToAction relative flex flex-col md:flex-row justify-between">
            <div class="col texto w-11/12 md:w-5/12 px-6 py-6 flex flex-col justify-center z-10">
                <h1 class="text-4xl font-bold mb-8 md:mb-5">Plan Avanzado</h1>
                <h2 class="text-xl mb-5">Antivirus Devastador <sup class="text-xs">TM</sup></h2>
                <p class="text-md mb-5">Nuestro software antivirus en su plan avanzado cubre las necesidades para los usuarios más exigentes que requieren la mejor protección en sus equipos, como gamers, maestros ó directores.</p>
                <div>
                    <a href="" class="p-2 bg-lime-600 hover:bg-lime-800 transition-colors text-white rounded-lg">Comprar Ahora</a>
                </div>
            </div>
            <div class="col hidden md:block md:relative right-0 w-10/12 md:w-7/12 z-0">
                <img src="./img/laptop2.png" alt="Mujer con laptop" style="width: 800px;">
            </div>
        </section>
            ...
            <div class="w-full max-w-screen-xl m-auto flex flex-col md:flex-row">
                <div class="w-full p-4 text-center flex flex-col md:flex-row items-center justify-center">
                    <div class="w-12/12 md:w-6/12 flex flex-col items-center">
                        <img src="./img/avanz.png" alt="Logotipo antivirus devastador" style="width: 280px;">
                    </div>
                    <div class="w-12/12 md:w-6/12 text-white text-center flex flex-col justify-center">
                        ...
                        <ul>
                            <li class="py-2 text-white">Compras Online protegidas</li>
                            <li class="py-2 text-white">Bloqueo de anuncios</li>
                            <li class="py-2 text-white">VPN</li>
                        </ul>
